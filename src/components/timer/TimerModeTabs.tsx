...
import { Flame, Coffee, Sparkles, RotateCcw } from 'lucide-react';
import { ExtendedTimerMode } from '../Timer';
...
export default function TimerModeTabs({ mode, onSelectMode }: TimerModeTabsProps) {
  return (
