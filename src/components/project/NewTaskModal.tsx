...
export default function NewTaskModal({
  ...
  const validDefaultProjectId =
    defaultProjectId && defaultProjectId !== 'all' && defaultProjectId !== 'uncategorized'
      ? defaultProjectId
      : '';
  ...
  return (
    ...
    >
      ...
      <div>
        <label className="block text-xs text-muted-foreground mb-1">Notes / Description (Optional)</label>
        <textarea
          value={description}
