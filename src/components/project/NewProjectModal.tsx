...
export default function NewProjectModal({
  ...
  return (
    <form onSubmit={onSubmit} className="glass-card rounded-2xl p-5 border border-border space-y-4 text-foreground shadow-xl animate-in fade-in zoom-in-95 duration-200">
